...
from ulearn.core.browser.stats import StatsQueryBase
from ulearn.core.browser.stats import STATS
from ulearn.core.browser.stats import first_moment_of_month
